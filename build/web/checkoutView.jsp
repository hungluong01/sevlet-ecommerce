            ...
            <ul class="list-group list-group mt-3">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        ...
                        <span class="badge bg-light text-dark rounded-pill">$<fmt:formatNumber value="${cartItem.product.price * cartItem.quantity}" /></span>
                </li>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    ...
                    <span class="badge bg-primary rounded-pill">$<fmt:formatNumber value="${total}"></fmt:formatNumber></span>
                </li>
            </ul>
        </div>
        <div class="col-md-8">
